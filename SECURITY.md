...
We take security seriously. If you discover a security vulnerability in WudiBuddy Agents, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **security@openwudi.com**
...
- The WudiBuddy Agents desktop application
- The `@craft-agent/*` npm packages
- Official WudiBuddy Agents repositories
