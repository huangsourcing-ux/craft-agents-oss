...
This guide explains how to customize the visual theme of WudiBuddy Agents.

## Overview

WudiBuddy Agents uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
