...
Place your skills in `~/.agents/skills/` and they'll work with WudiBuddy Agents, Codex, Gemini, and other tools that support this convention. Your existing workspace skills continue to work as before.
...
| Issue | Title | Status |
|-------|-------|--------|
| [craft-agents-oss#131](https://github.com/lukilabs/craft-agents-oss/issues/131) | WudiBuddy Agents on Hyprland creates multiple non-closable windows | Fixed |
