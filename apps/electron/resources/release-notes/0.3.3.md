...
When your OAuth token expires, WudiBuddy Agents automatically refreshes it in the background using the refresh token. No manual re-authentication required — your MCP connections stay alive.
