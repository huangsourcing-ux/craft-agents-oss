...
/**
 * Renders the production AppMenu inside a phone-shaped frame. The WudiBuddy logo
    ...
    <MobilePlaygroundProviders>
      <MobileWebUIFrame device={device} showBezel={showBezel}>
        <div className="flex flex-col h-full">
          {/* Faux TopBar so the WudiBuddy logo trigger sits in a recognisable strip */}
          ...
          <div className="flex-1 flex items-start justify-center pt-12">
            <p className="text-xs text-muted-foreground/70 px-6 text-center">
              Tap the WudiBuddy logo (top-left) to open the menu.<br />
