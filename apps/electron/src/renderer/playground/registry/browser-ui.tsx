...
function getLiveFxPayload(scenario: Scenario, runState: RunState): { active: boolean; label: string; cursor: { x: number; y: number } | null } {
  ...
  if (runState === 'running') {
    ...
    return {
      active: true,
      label: 'WudiBuddy Agents are working…',
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  ...
  'long-names': [
    {
      ...
      title: 'WudiBuddy Agents Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/craft-agents-oss',
      title: 'WudiBuddy Agents OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
