...
export type NavigatorType = 'sessions' | 'sources' | 'skills' | 'automations' | 'design' | 'projects' | 'settings'
...
const COMPOUND_ROUTE_PREFIXES = [
  'allSessions', 'flagged', 'archived', 'state', 'label', 'view', 'board', 'sources', 'skills', 'automations', 'design', 'projects', 'settings'
]
