#!/usr/bin/env bun
/**
 * Debug script to print the full WudiBuddy Agents system prompt with annotations.
...
printAnnotation('  2. WudiBuddy Agents Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// WudiBuddy Agents additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. WudiBuddy Agents Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
