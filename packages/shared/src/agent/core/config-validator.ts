...
/**
 * WudiBuddy Agents specific config files that have known schemas.
 */
...
export class ConfigValidator {
  ...
  /**
   * Check if a file path is a WudiBuddy Agents config file.
   *
   * @param filePath - Path to check
   * @returns true if this is a WudiBuddy Agents config
   */
