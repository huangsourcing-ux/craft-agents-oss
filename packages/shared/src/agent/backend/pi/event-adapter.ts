 ...
 * WudiBuddy Agents's AgentEvent format for UI compatibility.
 *
...
/**
 * Maps Pi SDK events to WudiBuddy Agents events for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more WudiBuddy Agents events.
   */
