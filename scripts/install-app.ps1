# WudiBuddy Agents Windows Installer
...
$process = Get-Process -Name "WudiBuddy Agents" -ErrorAction SilentlyContinue
if ($process) {
    Write-Info "Closing WudiBuddy Agents..."
...
$binDir = "$env:LOCALAPPDATA\WudiBuddy Agents\bin"
$cmdFile = "$binDir\craft-agents.cmd"
$exePath = "$env:LOCALAPPDATA\Programs\WudiBuddy Agents\WudiBuddy Agents.exe"
...
Write-Host ""
Write-Host "  WudiBuddy Agents has been installed."
Write-Host ""
